...
module "casestudy_compute" {
  ...
  elb_security_group = [module.casetsudy_vpc.AppinstanceSGName]
  elb_subnet_group   = [module.casetsudy_vpc.PublicSubnet1Name, module.casetsudy_vpc.PublicSubnet2Name]
  vpcid              = module.casetsudy_vpc.vpc-id
